...
// ─── RIGHT: Neural Camera Recognition ────────────────────────────────────────
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(0,217,255,0.06) 0%, transparent 70%)' }} />

      {/* Decorative rings */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[580px] h-[580px] rounded-full border border-[#00D9FF]/5 pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[380px] h-[380px] rounded-full border border-[#00D9FF]/8 pointer-events-none" />
      ...
      {/* ── CENTER CONTENT ── */}
      <div className={`relative z-10 max-w-xl mx-auto px-6 text-center transition-all duration-1000 ${
          mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}
      >
        {/* Status badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#00D9FF]/25 bg-[#00D9FF]/05 mb-8">
          <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
          <span className="text-xs font-mono text-slate-400 tracking-widest uppercase">Available for opportunities</span>
        </div>

        {/* Avatar */}
        <div className="flex justify-center mb-8">
          <div className="relative w-28 h-28">
            <div className="w-full h-full rounded-full border-2 border-[#00D9FF]/40 flex items-center justify-center bg-[#0a0a14] text-4xl font-display font-bold text-[#00D9FF] text-glow">
              MZ
            </div>
            <div className="absolute inset-0 rounded-full"
              style={{
                ...
                animation: 'heroOrbit 4s linear infinite',
              }}
            />
          </div>
        </div>
        ...
        {/* Name */}
        <h1 className="font-display font-extrabold text-5xl md:text-7xl text-white mb-3 tracking-tight leading-tight">
          Mohd Zishan{' '}
          <span className="gradient-text">Saifi</span>
        </h1>

        {/* Typing role */}
        <div className="h-10 flex items-center justify-center mb-6">
          <span className="font-mono text-lg md:text-2xl text-[#00D9FF] text-glow-sm">
            {typedText}<span className="cursor text-[#00D9FF]">|</span>
          </span>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-10">
          {personalInfo.stats.map((stat) => (
            <div key={stat.label} className="glass rounded-xl p-3.5 hover:border-[#00D9FF]/30 transition-all duration-300">
              <div className="stat-number text-xl text-[#00D9FF] text-glow mb-0.5">{stat.value}</div>
        ...
        <div className="flex items-center justify-center gap-2 text-slate-500 text-sm mb-8">
          ...
          <span className="font-body">{personalInfo.location}</span>
        </div>

        {/* CTAs */}
        <div className="flex flex-wrap items-center justify-center gap-3 mb-12">
          <a href="mailto:saifizeeshan895@gmail.com"
            className="inline-flex items-center gap-2 px-7 py-3 bg-[#00D9FF] text-[#050509] font-display font-bold rounded hover:bg-white hover:shadow-[0_0_30px_rgba(0,217,255,0.4)] transition-all duration-300 text-sm tracking-wide"
          >
            <Mail size={15} /> Get In Touch
          </a>
          <a href="https://github.com/mohdzishan" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-7 py-3 border border-[#00D9FF]/30 text-slate-300 hover:text-[#00D9FF] hover:border-[#00D9FF] hover:bg-[#00D9FF]/05 rounded transition-all duration-300 text-sm"
          >
            <Github size={15} /> GitHub
          </a>
          <a href="https://linkedin.com/in/mohdzishan" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-7 py-3 border border-[#0A66C2]/30 text-slate-300 hover:text-[#0A66C2] hover:border-[#0A66C2] hover:bg-[#0A66C2]/05 rounded transition-all duration-300 text-sm"
          >
